    ...
    <div class="container px-4 mx-auto">
      ...
      <div>
        ...
        <div class="flex items-center justify-start gap-4">
          <p><span class="font-bold">Phan Quang Dương 0373745152</span> Cầu Diễn, Phường Phúc Diễn, Quận Bắc Từ Liêm, Hà Nội</p>
          <div class="px-3 py-1 border border-dangerColor text-sm text-dangerColor rounded">Mặc Định</div>
          <button class="px-3 py-1 text-blueColor">Thay Đổi</button>
        </div>
      </div>
    </div>
  </div>
